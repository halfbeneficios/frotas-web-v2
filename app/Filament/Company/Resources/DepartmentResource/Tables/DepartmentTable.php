...
class DepartmentTable extends TableBuilder
{
    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->description('Listagem de todos os departamentos cadastrados no sistema')
            ->headerActions([])
            ...
            ->emptyStateDescription('Nenhum departamento foi cadastrado')
            ->striped();
    ...
    public static function getTableHeader(): Htmlable
    {
        ...
        $content = '<div class="flex-header">' . $icon . 'Departamentos</div>';
