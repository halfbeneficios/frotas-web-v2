...
class SubsidiaryTable extends TableBuilder
{
    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->description('Listagem de todas as filiais cadastradas no sistema')
            ->headerActions([])
            ...
            ->emptyStateDescription('Nenhuma filial foi cadastrada')
            ->striped();
    ...
    public static function getTableHeader(): Htmlable
    {
        ...
        $content = '<div class="flex-header">' . $icon . 'Filiais</div>';
