...
class FleetTypeTable extends TableBuilder
{
    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->description('Listagem de todos os tipos de frota cadastrados no sistema')
            ->headerActions([])
            ...
            ->emptyStateDescription('Nenhum tipo de frota foi cadastrado')
            ->striped();
    ...
    public static function getTableHeader(): Htmlable
    {
        ...
        $content = '<div class="flex-header">' . $icon . 'Tipos de Frota</div>';
