...
class EmployeeProfileTable extends TableBuilder
{
    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->description('Listagem de todos os perfis cadastrados no sistema')
            ->headerActions([])
            ...
            ->emptyStateDescription('Nenhum perfil foi cadastrado')
            ->striped();
    ...
    public static function getTableHeader(): Htmlable
    {
        ...
        $content = '<div class="flex-header">' . $icon . 'Perfis de Colaboradores</div>';
