...
namespace CompanyResource\Filament\Admin\Resources\CompanyResource\Tables;
...
class CompanyTable extends TableBuilder
{
    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->description('Listagem de todos as empresas cadastradas no sistema')
            ->headerActions([])
            ...
            ->emptyStateDescription('Nenhuma empresa foi cadastrada')
            ->striped();
    ...
    public static function getTableHeader(): Htmlable
    {
        ...
        $content = '<div class="flex-header">' . $icon . 'Empresas</div>';
