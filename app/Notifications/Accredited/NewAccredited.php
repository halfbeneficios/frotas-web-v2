...
namespace App\Notifications\Accredited;
...
class NewAccredited extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->action('Clique aqui para acessar nosso sistema', route('filament.accredited.auth.login'))
